...
最新进展：[运动设置与语音](docs/running-settings.md)，前一批为[骑行与室内跑步](docs/sport-modes.md)。后续按[功能对齐清单](docs/feature-alignment-plan.md)推进。
