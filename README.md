...
最新进展：[运动详情、指标与分享](docs/running-details-sharing.md)，此前已完成[运动设置与语音](docs/running-settings.md)。后续按[功能对齐清单](docs/feature-alignment-plan.md)推进。
